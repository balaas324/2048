document.addEventListener('DOMContentLoaded', ()=>{
    ...
    document.querySelector('.up').addEventListener('click', clickUp)
    ...
    document.querySelector('.down').addEventListener('click', clickDown)
  ...
  function addColours() {
    for (let i=0; i < squares.length; i++) {
      if (squares[i].innerHTML == 0) squares[i].style.backgroundColor = '#fff'
